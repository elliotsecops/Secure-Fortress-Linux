...
class TestBashScript:
    ...
    def script_path(self):
        ...
        return "/home/elliot/Documents/Reto scripts 30 dias/Fortress_Linux/scripts/linux_hardening.sh"
    ...
    def test_script_executable(self, script_path):
        ...
        assert stat.S_IMODE(file_stat.st_mode) & stat.S_IXUSR, "Script should be executable by owner"
    ...
    def test_script_security_content(self, script_path):
        ...
        assert len(found_operations) >= 5, f"Script should contain security operations, found: {found_operations}"
    ...
    def test_script_error_handling(self, script_path):
        ...
        assert len(found_handling) >= 2, f"Script should have error handling, found: {found_handling}"
    ...
    def test_script_sudo_usage(self, script_path):
        ...
        assert len(found_sudo) >= 2, f"Script should use sudo for privileged operations, found: {found_sudo}"
    ...
    def test_script_backup_operations(self, script_path):
        ...
        assert len(found_backup) >= 1, f"Script should include backup considerations, found: {found_backup}"
    ...
    def test_script_logging(self, script_path):
        ...
        assert len(found_logging) >= 2, f"Script should include logging, found: {found_logging}"
    ...
    def test_script_security_hardening_functions(self, script_path):
        ...
        assert len(found_functions) >= 4, f"Script should implement security hardening functions, found: {found_functions}"
    ...
    def test_script_configuration_files(self, script_path):
        ...
        assert len(found_configs) >= 3, f"Script should modify configuration files, found: {found_configs}"
    ...
    def test_script_service_management(self, script_path):
        ...
        assert len(found_services) >= 2, f"Script should manage services, found: {found_services}"
    ...
    def test_script_package_management(self, script_path):
        ...
        assert len(found_packages) >= 1, f"Script should manage packages, found: {found_packages}"
    ...
    def test_script_user_management(self, script_path):
        ...
        assert len(found_user_mgmt) >= 2, f"Script should include user management, found: {found_user_mgmt}"
    ...
    def test_script_network_security(self, script_path):
        ...
        assert len(found_network) >= 2, f"Script should include network security, found: {found_network}"
    ...
    def test_script_script_structure(self, script_path):
        ...
        assert len(found_structure) >= 3, f"Script should have good structure, found: {found_structure}"
    ...
    def test_script_safety_measures(self, script_path):
        ...
        assert len(found_safety) >= 1, f"Script should include safety measures, found: {found_safety}"